...
int CodTela=6;//cada tela tem um codigo, e retorna um inteiro que é o codigo da proxima tela
...
int TelaRecorde(){
    ...
    std::fscanf(file,"%s%s ", nomeJogador, pontos);
    std::fclose(file);
...
while (janela.isOpen()){
    ...
    std::string nomerecorde=n1;

    textoArcade4.setString(nomerecorde);
