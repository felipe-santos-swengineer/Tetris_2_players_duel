...
//Marco agr só falta vc colocar a sua logica de parar o tempo… e preciso que me diga onde a //nova peça está sendo criada e colocada na matriz player pra que eu dê uma melhorada na //condição de parada, basicamente é so verificar se as posicções da nova peça estao true na //matriz espelho, ou seja olhar isso no lugar de se referenciar na primeira linha da matriz.
// também nn podemos esquecer de colocar o condicional de rotação para que nn gire no meio de //colisoes… vlw por enquanto é só isso.
...
/// ESSE É O ALGORITMO MAIS ATUALIZADO - 12-10-2018
...
fimdojogo: //p2 é o ponto que o goto vem
