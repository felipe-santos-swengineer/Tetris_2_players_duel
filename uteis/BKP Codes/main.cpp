...
int main(){
    ...
    int codigoPeca[9][8]={0,0,0,1,0,2,0,3,//guarda 9 codigos diferentes de 8 posicoes
                          0,0,0,1,1,1,1,2,
                          0,0,1,0,0,1,1,1,
                          0,1,0,2,1,0,1,1,
                          0,0,1,0,1,1,2,1,
    ...
    for(i=0;i<9;i++){
        for(j=0;j<8;j++){
                if(j<4){
                    if(j%2==0){
                        coordenadasdaspecas[i][j].px=codigoPeca[i][j];
                    } else {
                        coordenadasdaspecas[i][j].py=codigoPeca[i][j];
                    }
                } else {
                    if(j%2==0){
                        coordenadasdaspecas[i][j-4].px=codigoPeca[i][j];
                    } else {
                        coordenadasdaspecas[i][j-4].py=codigoPeca[i][j];
                    }
                }
        }
